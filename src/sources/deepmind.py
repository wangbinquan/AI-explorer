...
class DeepMindSource(Source):
    """Google DeepMind blog. RSS at /blog/rss.xml is server-rendered and clean.
    Note: www.deepmind.com 302s to deepmind.google — we point straight at the
    canonical host."""
    name = "deepmind"

    def fetch(self) -> list[Item]:
        url = self.config.get("rss_url", "https://deepmind.google/blog/rss.xml")
        ...
        try:
            ...
            log.warning("deepmind feed fetch failed: %s", e)
            return []
